...
### Challenge: Convert an Account to a Customer
...
- **Task Creation via Flow**

#### Challenge Completion Proof

- ✅ **Autolaunched Flow created** to convert a prospect Account
- ✅ **Input variable configured** (`accountID`) for external invocation
- ✅ **Date formula resource** created using `TODAY() + 7`
- ✅ **Account record updated** to Type = _Customer – Direct_
- ✅ **Onboarding Task created** and related to the Account
- ✅ **Task configured** with priority, status, subject, and due date
- ✅ **Flow saved and ready for execution** (`Convert_to_Customer`)
- 📸 **Screenshots captured**: Flow resources, Account update, Task creation

  <img src="../assets/D04_M02_C01.png" alt="Flow" width="500px">
...
### Challenge: Mark New Leads If There’s Already an Account With That Name
...
- **Get Records Element**
- **Sorting and Record Selection**
- **Update Records Element**
- **Lead Data Enrichment**

#### Challenge Completion Proof

- ✅ **Custom lookup field** created on Lead to reference Account
- ✅ **Record-triggered flow** configured to run on Lead creation
- ✅ **Matching logic implemented** using Lead Company and Account Name
- ✅ **Most recent Account selected** via CreatedDate descending sort
- ✅ **Lead updated automatically** with Possible Matching Account
- ✅ **Flow saved and activated** (`Check_New_Lead_for_Matching_Account`)
- 📸 **Screenshots captured**: Lookup field setup, Get Records sorting, Update Records configuration!

  <img src="../assets/D04_M02_C02.png" alt="Flow" width="500px">
...
### Challenge: Add Chatter and Email to the New Lead Flow

#### Skills Demonstrated

- **Record-Triggered Flows**
- **Flow Actions Configuration**
- **Chatter Automation**
- **Email Alerts**
- **Public Groups**
...
- ✅ **Existing Lead record-triggered flow enhanced** to support actions
- ✅ **Public Group created** (`Lead_Routing`) for notification routing
- ✅ **Email alert configured** targeting the Lead Routing public group
- ✅ **Plain-text Chatter message template created** with owner @mention
- ✅ **Chatter post action added** to notify matching Account owner
- ✅ **Email action added** to notify Lead Routing group
- ✅ **Flow saved and updated successfully**
- 📸 **Screenshots captured**: Public group, email alert, Chatter action, email action

  <img src="../assets/D04_M02_C03_a.png" alt="Public Group" width="500px">
  <br>
  <br>
  <img src="../assets/D04_M02_C03_b.png" alt="Flow" width="500px">
